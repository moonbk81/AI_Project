...
> 본 프로젝트는 단순 RAG가 아니라 **Parser → Structured Event → RCA → Retrieval → Guardrail → LLM** 구조를 사용하여 Hallucination을 최소화하고 Fact 기반 Root Cause Analysis 정확도를 높입니다.

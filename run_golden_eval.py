...
3) RAG 모델 준비
- RilRagChat에서 사용할 RAG 모델을 준비합니다 (예: gemma4:12b).
- RilRagChat이 해당 모델을 올바르게 로드할 수 있는지 확인합니다.
4) 실행
- 터미널에서 다음 명령어로 평가 스크립트를 실행합니다:
python run_golden_eval.py --judge-model ollama/gemma4:26b --rag-model gemma4:12b
...
python run_golden_eval.py --judge-model ollama/qwen2.5-coder:7b --rag-model gemma3:4b
"""
...
if __name__ == "__main__":
    ...
    parser.add_argument("--rag-model", default="gemma4:12b", help="우리 RAG 모델명")
